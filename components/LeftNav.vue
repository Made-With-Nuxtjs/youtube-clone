<template>
  <div>
    <!-- Subcription nav Item-1 -->
    <v-divider></v-divider>

    <h4 class="overline pl-4 text--disabled">Subcriptions</h4>
    <v-list-item
    ...
    return {
      items1: [
        ...
        },
        {
          ...
          title: 'Coding step by step',
          to: '/',
        },
        {
          icon: 'mdi-trophy-outline',
          title: 'Coding with Danny',
          to: '/',
        },
        {
