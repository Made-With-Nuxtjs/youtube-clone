      ...
      <v-card>
        ...
        <v-list>
          ...
          <a class="text-decoration-none" href="#">
            <v-list-item>
              ...
              <v-list-item-title class="subtitle-2"
                >Puchases and memberships</v-list-item-title
              >
            </v-list-item>
          </a>
          <a class="text-decoration-none" href="#">
            <v-list-item>
              ...
              <v-list-item-title class="subtitle-2"
                >YouTube Studio</v-list-item-title
              >
            </v-list-item>
          </a>
          <a class="text-decoration-none" href="#">
        ...
        <v-list dense>
          ...
          <a class="text-decoration-none" href="#">
            <v-list-item dense>
              ...
              <v-list-item-title class="subtitle-2"
                >Language: <span>English</span></v-list-item-title
              >
            </v-list-item>
          </a>
          <a class="text-decoration-none" href="#">
            <v-list-item>
              ...
              <v-list-item-title class="subtitle-2"
                >Location: <span>Bangladesh</span></v-list-item-title
              >
            </v-list-item>
          </a>
          <a class="text-decoration-none" href="#">
          ...
          <a class="text-decoration-none" href="#">
            <v-list-item>
              ...
              <v-list-item-title class="subtitle-2"
                >Your Data in YouTube</v-list-item-title
              >
            </v-list-item>
          </a>
          <a class="text-decoration-none" href="#">
          ...
          <a class="text-decoration-none" href="#">
            <v-list-item>
              ...
              <v-list-item-title class="subtitle-2"
                >Keybord Shortcuts</v-list-item-title
              >
            </v-list-item>
          </a>
          <v-divider></v-divider>
        ...
        <v-list>
          <a class="text-decoration-none" href="#">
            <v-list-item>
              <v-list-item-title class="subtitle-2"
                >Restricted Mode: <span>Off</span></v-list-item-title
              >
            </v-list-item>
          </a>
        </v-list>
