      ...
      <v-col cols="12" md="9" >
        <v-row dense>
          <v-col v-for="card in cards" :key="card.title" :cols="card.flex">
            <!-- visible sx/sm...only //down card-->
            <v-card  fixed class=" sticky-card hidden-sm-and-up">
              <v-img :src="card.src">
            ...
            <div dense tile class="after-sticky">
              ...
              <div class="d-flex justify-space-between white--text">
                <div class="d-inline-flex d-sm-flex">
                  ...
                  >
                  <span
                    class="text-subtitle-2 font-weight-thin hidden-md-and-down"
                    >. 1 week ago</span
                  >
                </div>
                ...
                <div class="d-sm-flex">
                  <v-btn class="matchColor pa-0">
                    <v-icon class="pr-1 pa-0">mdi-thumb-up-outline</v-icon>
                    <span>3</span>
                  </v-btn>
                  <v-btn class="matchColor pa-0">
                    <span class=""
                  ...
                  <v-btn class="matchColor pa-0">
                    ...
                    <span class="ml-2">SHARE</span></v-btn
                  >
                  <v-btn class="matchColor pa-0 d-none d-sm-flex">
                ...
                <span class="mb-4">
                  ...
                  <v-expand-transition class="bottom">
                    <div v-show="show">
                      Lorem ipsum, dolor sit amet consectetur adipisicing elit.
                      Assumenda, qui.Lorem ipsum, dolor sit amet consectetur
                      adipisicing elit. Assumenda, qui. Lorem ipsum, dolor sit
                      amet consectetur adipisicing elit. Assumenda, qui.Lorem
                      ipsum, dolor sit amet consectetur adipisicing elit.
                      Assumenda, qui. I'm a thing. But, like most politicians,
                      he promised more than he could deliver. You won't have
                      time for sleeping, soldier, not with all the bed making
                      you'll be doing. Then we'll go with that data file! Hey,
                      you add a one and two zeros to that or we walk! You're
