      ...
      <v-col cols="12" md="9" class="flex-grow-1 flex-shrink-0">
        ...
        <v-row dense>
          <v-col v-for="card in cards" :key="card.title" :cols="card.flex">
            <v-card>
              <v-img :src="card.src" max-height="600px" />
            ...
            <div dense tile>
              ...
              <v-row>
                ...
                <v-col cols="9">
                  ...
                  >
                  <v-btn class="float-right matchColor pa-0 mr-3"
                    ><v-icon class="pr-2" size="24">mdi-playlist-plus</v-icon
                    >SAVE</v-btn
                  >
                  <v-btn class="float-right matchColor pa-0 mr-3"
                    ><v-icon class="pr-2" size="24">mdi-share </v-icon
                    >SHARE</v-btn
                  >
                  <v-btn class="float-right matchColor pa-0"
                    ><v-icon class="pr-2" size="24">mdi-thumb-down </v-icon
                    >0</v-btn
                  >
                  <v-btn class="float-right matchColor pa-0"
                    ><v-icon class="pr-2" size="24">mdi-thumb-up</v-icon
                    >3</v-btn
                  >
                </v-col>
              </v-row>
            ...
            <div>
              ...
              <div class="mx-4">
                  ...
                  <span class="mb-4">
                    ...
                    <v-expand-transition class="bottom">
                      <div v-show="show">
                        ...
                        elit. Assumenda, qui.Lorem ipsum, dolor sit amet
                        consectetur adipisicing elit. Assumenda, qui. Lorem
                        ipsum, dolor sit amet consectetur adipisicing elit.
                        Assumenda, qui.Lorem ipsum, dolor sit amet consectetur
                        adipisicing elit. Assumenda, qui. I'm a thing. But, like
                        most politicians, he promised more than he could
                        deliver. You won't have time for sleeping, soldier, not
                        with all the bed making you'll be doing. Then we'll go
                        with that data file! Hey, you add a one and two zeros to
                        that or we walk! You're going to do his laundry? I've
                        got to find a way to escape.
                      </div>
                    </v-expand-transition>
                  </span>
                  <div color="orange lighten-2" text @click="show = !show">
                ...
                <div class="d-inline-flex white--text my-6 mx-2 d-none d-sm-flex">
                  ...
                  <span
                    class="d-inline-flex white--text mt-3"
                    style="
                      font-size: 13px;
                      font-family: Robot, Arial, sans-serif;
                    "
