          ...
          <v-row no-gutters>
            <v-col md="4" sm="4">
              <v-card class="pa-2" flat tile>
                ...
                >
                  <v-icon class="float-end pr-2 pt-1" size="16"
                  ...
                  <v-card-actions style="margin-top: 145px">
                    <v-btn icon>
            ...
            <v-col md="4" sm="4">
              <v-card class="pa-2" flat tile>
                ...
                <div class="pl-4 text-wrap white--text">
                  <span class="mb-2">
                    <p>
                   ...
                   <nuxt-link to="/videoView" class="text-decoration-none white--text">
